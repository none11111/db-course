...
class Config:
    ...
    # 文件上传配置
    UPLOAD_FOLDER = os.path.join(basedir, 'static', 'uploads')  # 上传文件存储目录
    ...
    MAIL_USERNAME = os.environ.get('MAIL_USERNAME') or 'your_email@qq.com'  # 你的邮箱地址
    MAIL_PASSWORD = os.environ.get('MAIL_PASSWORD') or 'your_email_password'  # 邮箱密码或授权码
    MAIL_DEFAULT_SENDER = os.environ.get('MAIL_DEFAULT_SENDER') or 'your_email@qq.com'  # 默认发件人
